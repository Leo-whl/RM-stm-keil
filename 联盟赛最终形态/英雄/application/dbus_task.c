...
void xyz_get() {
    ...
    rc_deadband_limit(rc_ctrl.CH3 - 1024, cheche_data.vz, DEADLINE, UPLINE);
    rc_deadband_limit(rc_ctrl.CH4 - 1024, pitch_rad_mid, DEADLINE, UPLINE);
	cheche_data.vx *= (X_MAX_SPEED / UPLINE);
    cheche_data.vy *= (Y_MAX_SPEED / UPLINE);
    cheche_data.vz /= UPLINE;
