...
#define CALI_GET_TIMES 20000.0f
/**
...
//fp32 gyro_offset[3] = {0.00822737627f, 0.00453814957f, 0.000750813982f};
fp32 gyro_offset[3] = {0.000321290456f, 0.0014474116f, -0.00347122736f};
...
//    }
    ...
    imu_start_dma_flag = 1;
		if (gyro_offset[0] == 0.0f) cali_flag = 1;
		else cali_flag = 0;
    while (1)
    {
        ...
        if(gyro_update_flag & (1 << IMU_NOTIFY_SHFITS))
        {
            ...
            BMI088_gyro_read_over(gyro_dma_rx_buf + BMI088_GYRO_RX_BUF_DATA_OFFSET, bmi088_real_data.gyro);
					  if(cali_times > CALI_GET_TIMES) cali_flag =0;
					  if(cali_flag) INS_cali_gyro( a, b, &cali_times);		
        }
        ...
        accel_fliter_3[2] = accel_fliter_2[2] * fliter_num[0] + accel_fliter_1[2] * fliter_num[1] + INS_accel[2] * fliter_num[2];
				...
				vvvvv += accel_fliter_3[1] - accel_fliter_2[1];
				
        AHRS_update(INS_quat, 0.001f, INS_gyro, accel_fliter_3, INS_mag);
        get_angle(INS_quat, INS_angle + INS_YAW_ADDRESS_OFFSET, INS_angle + INS_PITCH_ADDRESS_OFFSET, INS_angle + INS_ROLL_ADDRESS_OFFSET);
				buffer[0] = INS_angle[0]*57.3f;buffer[1] = INS_angle[1]*57.3f;buffer[2] = INS_angle[2]*57.3f;
    }
}
