...
void remote_task_entry(void const * argument);
...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(remote_task, remote_task_entry, osPriorityIdle, 0, 128);
...
__weak void remote_task_entry(void const * argument)
{
