...
//		CAN_cmd_chassis(motor_pid0.out,motor_pid1.out,motor_pid2.out,motor_pid3.out);	
	...
	{
//		PID_calc(&position_pid0,err0,0);
//		PID_calc(&motor_pid0,motor_data0->speed_rpm,position_pid0.out);
//		PID_calc(&position_pid1,err1,0);
//		PID_calc(&motor_pid1,motor_data1->speed_rpm,position_pid1.out);	
		angal_ctrl();
		PID_calc(&motor_pid0,motor_data0->speed_rpm,set_speed0-100.0f*angal_err);
		PID_calc(&motor_pid1,motor_data1->speed_rpm,set_speed1-100.0f*angal_err);
		PID_calc(&motor_pid2,motor_data2->speed_rpm,set_speed2-100.0f*angal_err);
		PID_calc(&motor_pid3,motor_data3->speed_rpm,set_speed3-100.0f*angal_err);
		CAN_cmd_chassis(motor_pid0.out,motor_pid1.out,motor_pid2.out,motor_pid3.out);			
	}
}
