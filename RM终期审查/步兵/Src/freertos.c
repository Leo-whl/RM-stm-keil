...
void led_flow_task_entry(void const * argument);
...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(chassis_task, chassis_task_entry, osPriorityRealtime, 0, 256);
  chassis_taskHandle = osThreadCreate(osThread(chassis_task), NULL);

  /* definition and creation of gimbal_task */
  osThreadDef(gimbal_task, gimbal_task_entry, osPriorityRealtime, 0, 256);
  ...
  osThreadDef(led_flow_task, led_flow_task_entry, osPriorityIdle, 0, 128);
...
/* USER CODE BEGIN Header_led_flow_task_entry */
/**
* @brief Function implementing the led_flow_task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_led_flow_task_entry */
__weak void led_flow_task_entry(void const * argument)
{
  /* USER CODE BEGIN led_flow_task_entry */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END led_flow_task_entry */
}
