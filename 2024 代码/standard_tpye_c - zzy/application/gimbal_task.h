/**
  ...
  *             状态，陀螺仪控制状态是利用板载陀螺仪解算的姿态角进行控制，编码器控制				更改
...
#define PITCH_SPEED_PID_KP        6500.0f       //2900.0
#define PITCH_SPEED_PID_KI        0.0f         //60.0
#define PITCH_SPEED_PID_KD        15.0f          //0.0
#define PITCH_SPEED_PID_MAX_OUT   30000.0f
#define PITCH_SPEED_PID_MAX_IOUT  10000.0f

//yaw speed close-loop PID params, max out and max iout
//yaw 速度环 PID参数以及 PID最大输出，积分输出
#define YAW_SPEED_PID_KP        6500.0f					//600      4600
#define YAW_SPEED_PID_KI        30.0f						//0        30
#define YAW_SPEED_PID_KD        3.0f						//0         3
#define YAW_SPEED_PID_MAX_OUT   30000.0f				//
#define YAW_SPEED_PID_MAX_IOUT  5000.0f					//5000

//pitch gyro angle close-loop PID params, max out and max iout
//pitch 角度环 角度由陀螺仪解算 PID参数以及 PID最大输出，积分输出
#define PITCH_GYRO_ABSOLUTE_PID_KP 30.0f       //15
#define PITCH_GYRO_ABSOLUTE_PID_KI 0.0f        //0
#define PITCH_GYRO_ABSOLUTE_PID_KD 0.05f        //0
...
#define YAW_GYRO_ABSOLUTE_PID_KP        30.0f			//60
#define YAW_GYRO_ABSOLUTE_PID_KI        0.5f			//0.5
#define YAW_GYRO_ABSOLUTE_PID_KD        0.15f     //0.15
#define YAW_GYRO_ABSOLUTE_PID_MAX_OUT   10.0f			//10
#define YAW_GYRO_ABSOLUTE_PID_MAX_IOUT  0.0f			//0

//pitch encode angle close-loop PID params, max out and max iout
//pitch 角度环 角度由编码器 PID参数以及 PID最大输出，积分输出
#define PITCH_ENCODE_RELATIVE_PID_KP 65.0f    //15
#define PITCH_ENCODE_RELATIVE_PID_KI 0.00f    //0
#define PITCH_ENCODE_RELATIVE_PID_KD 0.0f     //0
