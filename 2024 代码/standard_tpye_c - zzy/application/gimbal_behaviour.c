/**
  ...
  *             angle to control. and has some special mode:cali mode, motionless					更改
  *             mode.
...
void gimbal_behaviour_mode_set(gimbal_control_t *gimbal_mode_set)
{
    ...
    else if (gimbal_behaviour == GIMBAL_ABSOLUTE_ANGLE)
    {
		...
		gimbal_mode_set->gimbal_pitch_motor.gimbal_motor_mode = GIMBAL_MOTOR_ENCONDE;       //更改
    }
...
{
   return gimbal_behaviour == GIMBAL_MOTIONLESS;			//更改
}
