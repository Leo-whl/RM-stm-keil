/**
  ...
  *  V1.1.0     Nov-11-2019     RM              1. add chassis power control						更改
  *
  @verbatim
  ==============================================================================
...
//底盘3508最大can发送电流值
#define MAX_MOTOR_CAN_CURRENT 16000.0f    //16000

////底盘360旋转按键
#define REVOLVE_START_KEY  KEY_PRESSED_OFFSET_SHIFT 			//更改
...
//底盘电机速度环PID
#define M3505_MOTOR_SPEED_PID_KP 4000.0f         //15000    6000
#define M3505_MOTOR_SPEED_PID_KI 0.0f           //10      0
...
//小陀螺旋转PID，第二种方法时用
#define CHASSIS_REVOLCE_PID_KP 40.0f        //40.0
#define CHASSIS_REVOLCE_PID_KI 0.0f
#define CHASSIS_REVOLCE_PID_KD 0.0f						//更改
...
typedef struct
{
  ...
  pid_type_def chassis_angle_pid;              //follow angle PID.底盘跟随角度pid
	//pid_type_def revolve_pid;                    //小陀螺旋转pid						//更改
...
//		fp32 revolve_angle;//用于计算小陀螺旋转时前进时二维矩阵三角函数			//更改
